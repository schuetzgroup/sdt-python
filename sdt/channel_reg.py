...
other channel. The :py:class:`Registrator` class offers an easy way to do this.
...
There is also support for saving and loading a :py:class:`Registrator` instance
to/from YAML:
